...
// Import Menu Item
import { FilterSubSegmentComponent } from './filter-sub-segment.component';

// Define component
export default {
    title: 'Organisms/FilterSubSegment',
    component: FilterSubSegmentComponent,
...
// Define template
const FilterSubSegmentTemplate: Story<FilterSubSegmentComponent> = (args: FilterSubSegmentComponent) => ({
    props: { ...args },
    template: `<nwn-filter-sub-segment></nwn-filter-sub-segment>`,
});

export const FilterSubSegment = FilterSubSegmentTemplate.bind({});
FilterSubSegment.storyName = 'Filter sub segment';
FilterSubSegment.args = {};
